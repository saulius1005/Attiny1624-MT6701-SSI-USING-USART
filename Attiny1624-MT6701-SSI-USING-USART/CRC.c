...
/**
 * @brief CRC-8 Lookup table used for calculating the CRC.
 * 
 * This table contains the precomputed CRC values for all possible 8-bit input 
 * values, based on the CRC-8 MAXIM polynomial.
 */
